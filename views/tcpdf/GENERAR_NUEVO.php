...
if($agencias != 1){
	...
	$pdf->Ln(4);
	$pdf->Write(0, utf8_encode('Se encuentra pendiente de se�alar las agencias en derecho, pues el Juzgado de Oralidad en el respectivo auto que orden� seguir adelante con la ejecuci�n las omiti�.'), '', 0, 'L', true, 0, false, false, 0);
	$pdf->Ln(4);
