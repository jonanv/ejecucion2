...
if($agencias != 1){
	...
	$pdf->Ln(4);
	$pdf->Write(0, utf8_encode('Se encuentra pendiente de liquidar costas.'), '', 0, 'L', true, 0, false, false, 0);
	$pdf->Ln(4);
}
else{
	...
	$pdf->Ln(4);
	$pdf->Write(0, utf8_encode('Se encuentra pendiente de señalar las agencias en derecho, pues el Juzgado de Oralidad en el respectivo auto que ordenó seguir adelante con la ejecución las omitió.'), '', 0, 'L', true, 0, false, false, 0);
	$pdf->Ln(4);
...
/*if($agencias != 1){
	$pdf->Image('examples/images/escudo.jpg', 98, 150, 15, 15, 'JPG', '', '', true, 150, '', false, false, 1, false, false, false);
}
else{
	$pdf->Image('examples/images/escudo.jpg', 98, 105, 15, 15, 'JPG', '', '', true, 150, '', false, false, 1, false, false, false);
}*/
...
$pdf->Ln(4);
$pdf->Write(0, $dato8e, '', 0, 'J', true, 0, false, false, 0);		
