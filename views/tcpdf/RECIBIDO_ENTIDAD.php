...
//$pdf->Write(0, 'SECCIONAL CALDAS', '', 0, 'C', true, 0, false, false, 0);
	...
	$query = "	
				...
				SELECT t1.id,t2.radicado,t3.empleado,t1.fecha,t1.hora,t1.des,t1.folios,
				t3.correo,t3.celular
				FROM ((expe_entidad_memo t1
	...
	//while($row = mysql_fetch_array($sql)){
		...
		$pdf->Write(0, 'ARCHIVOS', '', 0, 'L', true, 0, false, false, 0);
		...
		$query = "	
						...
						SELECT * FROM expe_entidad_memo_detalle
						WHERE id_entidad_memo = '$iddda_acta'
