...
if($agencias != 1){
	...
	$pdf->Write(0, utf8_encode('A Despacho del señor Juez  el presente proceso el cual se encuentra pendiente de liquidar costas y liquidación de crédito presentada por la parte actora'), '', 0, 'J', true, 0, false, false, 0);
	//$pdf->Ln(4);
	//$pdf->Write(0, utf8_encode('En cumplimiento al contenido del artículo 366 del código General del Proceso, se procede a realizar la liquidación de costas al presente proceso, a cargo de los demandados, de la siguiente manera:'), '', 0, 'L', true, 0, false, false, 0);
	$pdf->Ln(4);
}
else{
...
$pdf->Ln(4);
$pdf->Write(0, utf8_encode('Lo anterior, con ocasión a la creación de este Juzgado mediante Acuerdo No. PSAA13-9962 de julio 31 de 2013 expedido por la Sala Administrativa del Consejo Superior de la Judicatura.'), '', 0, 'L', true, 0, false, false, 0);		*/
$pdf->SetFont('helvetica', '', 12);
$pdf->Ln(4);
...
$pdf->Ln(4);
$pdf->Write(0, utf8_encode('De igual forma, córrase traslado a la liquidación de crédito presentada de conformidad con el artículo 110 del código General del Proceso.'), '', 0, 'J', true, 0, false, false, 0);		
