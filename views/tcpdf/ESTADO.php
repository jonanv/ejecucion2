			...
			if ( move_uploaded_file($_FILES['archivo']['tmp_name'], $carpeta."/".$nom.'/'.$nombre_archivo) ){
				...
				while ($archivo = readdir($directorio)){
					...
					if (is_dir($archivo)){//verificamos si es o no un directorio
						...
						//TODO EL REGISTRO
						//El elemento HTML <nobr> previene que una l�nea de texto se divida en una nueva l�nea, 
						//as�, se presentar� en una l�nea larga por lo que puede ser necesario hacer un
						//desplazamiento de pantalla. Esta etiqueta no es un est�ndar HTML y no deber�a ser usada, 
						//en su lugar use la propiedad CSS white-space como en este ejemplo:
						//<span style="white-space: nowrap">L�nea larga sin saltos</span>
