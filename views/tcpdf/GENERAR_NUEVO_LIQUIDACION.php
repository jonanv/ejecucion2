...
if($agencias != 1){
	...
	$pdf->Ln(4);
	$pdf->Write(0, utf8_encode('Se encuentra pendiente de liquidar costas y liquidaci�n de cr�dito presentada por la parte actora'), '', 0, 'J', true, 0, false, false, 0);
	$pdf->Ln(4);
}
else{
...
$pdf->Ln(4);
$pdf->Write(0, utf8_encode('De igual forma, c�rrase traslado a la liquidaci�n de cr�dito presentada de conformidad con el art�culo 110 del c�digo General del Proceso.'), '', 0, 'L', true, 0, false, false, 0);		
