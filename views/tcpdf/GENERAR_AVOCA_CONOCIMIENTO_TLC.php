...
$pdf->SetFont('helvetica', '', 12);
$pdf->Ln(4);
$pdf->Write(0, utf8_encode('Atendiendo la constancia secretarial que antecede, se AVOCA CONOCIMIENTO del presente proceso al cual se ordena imprimirle el tr�mite de rigor.'), '', 0, 'L', true, 0, false, false, 0);		
$pdf->Ln(4);
...
$pdf->Ln(4);
$pdf->Write(0, utf8_encode('De igual forma, c�rrase traslado a la liquidaci�n de cr�dito presentada de conformidad con el articulo 110 del C�digo general del Proceso.'), '', 0, 'L', true, 0, false, false, 0);
$pdf->Ln(4);
