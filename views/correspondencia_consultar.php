...
?>
  ...
  <tr>
	...
	<td><div id="txtnegro">Numero Guia:</div></td>
    ...
    <td>
		...
		<?php 
			...
			$RUTA_GUIA = "http://svc1.sipost.co/trazawebsip2/frmReportTrace.aspx?ShippingCode=".$field[nunguia];
				
		?>
				
		<a class="ruta_guia" data-ruta="<?php echo $RUTA_GUIA; ?>"><?php echo $field[nunguia];?></a>
