...
<?php 
	...
	if($opcion == 1){
		...
		$datosACCION_1 = $modelo->listar_expediente_titulos_filtro($datoJXX1,$datoJXX3,$datoJXX5,$datoJXX2,$datoJXX4,$datoJXX6);
			
		//*********************CANTIDAD REGISTROS*****************************************
		
		$datosACCION = $modelo->listar_expediente_titulos_filtro($datoJXX1,$datoJXX3,$datoJXX5,$datoJXX2,$datoJXX4,$datoJXX6);
		...
		$datosACCION = $modelo->listar_expediente_titulos($datoJXX1);
...
$(document).ready(function() {
	...
	$("#buscar_pro").click(function(evento){
			...
			if( 
				...
				location.href="index.php?controller=archivo&action=Busquedad_Titulos_Consulta&dato_0="+dato_0+"&dato_1="+dato_1+"&dato_2="+dato_2+"&datox1="+datox1+"&datox2="+datox2+"&datox4="+datox4+"&datox6="+datox6;
