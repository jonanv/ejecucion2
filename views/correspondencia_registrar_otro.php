...
<table border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td style="background:url(views/images/crm_fondo_body.png) repeat-y;"><div id="contenido">
      <form id="frm" name="frm" method="post" enctype="multipart/form-data" action="">
        <div id="titulo_frm">Registrar Correspondencia Otro</div>
        <table border="0" cellspacing="0" cellpadding="0" id="frm_editar">
          <tr>
            <td width="151">Radicado:</td>
            <td width="564"><label>
              <input type="text" name="radicado" id="txt_input"/>
            </label></td>
          </tr>
          <tr>
            <td>Juzgado:</td>
 ...
 ?>
          ...
          <tr>
            ...
            <td>Oficio 
              <label>
              <input type="radio" name="esOficio_Telegrama" id="radio" value="Oficio" checked="checked" />
              </label> 
              Telegrama 
              <input type="radio" name="esOficio_Telegrama" id="radio2" value="Telegrama" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><textarea name="direccion" rows="4"  id="txt_input" class="required"></textarea>
              <label></label></td>
          </tr>
          <tr>
            <td>Departamento:</td>
 ...
 ?>
      ...
      $fecha=date('Y-m-d');?>
            <td><input type="text" name="fecha" id="txt_input" class="required" value="<?php echo $fecha;?>" readonly="readonly"/>
              <input name="cantidad1" type="hidden" id="cantidad1" value="0" /></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><label>
