...
<h2 class="page-header">
	...
	<br>
	<h3><?php //echo "ID: ".$id_radi." RADICADO: ".$nradi;
		?></h3>
		...
		<td>
			...
			<div class="form-row">
				...
				<div class="form-group col-md-2">
				  ...
				  <input type="text" class="form-control" name="filtro1" id="filtro1" value="<?php //echo trim($_GET['datox1']); 
	...
	<table class="table table-striped table-bordered table table-hover" id="tsoli">
		<thead>
			<tr class="success">
				...
				<!-- <th style="width:80px; text-align:center"><?php //echo utf8_encode('Tama�o'); 
																?></th> -->
				...
				if(count($d9M_6) > 1){
					...
					for($a = 0; $a<count($d9M_6); $a++){
						...
						if($pos_year >= 20){
							...
							//Eliminamos el elemento de la posici�n 0 "210409112903"
					...
					//El elemento �210409112903� se elimina, pero la posici�n que ten�a se mantiene. Si imprimimos el array el resultado ser�
					//Posici�n 0 = null
					//Posici�n 1 = xxx
					//Posici�n 2 = xxx
					//Por eso aplicamos array_values
					//Para reordenar las posiciones, el resultado ser�
					//Posici�n 0 = xxx
					//Posici�n 1 = xxx
		...
		?>
			...
			<tr>
				...
				<?php echo $d3M; //hora Incorporaci�n Expediente
				?>
				...
				if (!empty($d8M)) {
					...
					//VIDEO
					if (
						$d9M_5 == "MPG"  || $d9M_5 == "MP1" || $d9M_5 == "MP2" || $d9M_5 == "MP3" || $d9M_5 == "M1V" ||
							...
							<td>
								...
								<a id="cargar_indice" title="CARGA INDICE ELECTRONICO">
									...
									<button type="button" class="btn btn-success" title="CARGA INDICE ELECTRONICO">
										...
										<h4>CARGAR INDICE ELECTRONICO</h4>
									</button>
							...
							<td>
								...
								<a id="exportar_indice" title="EXPORTAR A EXCEL INDICE ELECTRONICO">
									...
									<button type="button" class="btn btn-success" title="EXPORTAR A EXCEL INDICE ELECTRONICO">
										<span class="glyphicon glyphicon-arrow-up"></span>
										<h4>EXPORTAR A EXCEL INDICE ELECTRONICO</h4>
									</button>
