...
<center><h2 class="page-header">PQR(S)</h2></center>
        ...
        <tr>
				...
				<td style="width:120px; text-align:center"> 
					...
					<?php 
						...
						echo utf8_encode($d3M)."<br>"."<br>".utf8_encode($d12M); //correo / celular
				...
				<td style="width:120px; text-align:center"> 
					...
					<?php //echo utf8_encode($d6M); //asunto?>
