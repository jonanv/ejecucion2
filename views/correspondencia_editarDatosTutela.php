...
function validar_ex(frm)
{
  ...
  arreglo_r = frm.radicado_lista.value;
  
  
   array = arreglo_r.split(",");
   index = array.indexOf(radicado);
...
<!--Función para crear las actuaciones-->
...
<table border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td style="background:url(views/images/crm_fondo_body.png) repeat-y;"><div id="contenido">
      <form id="frm" name="frm" method="post" enctype="multipart/form-data" action="">
        <div id="titulo_frm">Modificar Datos Tutela &oacute; Incidente</div>
        <table border="0" cellspacing="0" cellpadding="0" id="frm_editar">
          <tr>
            ...
            <?php  $radicado_cadena="";
			$i=$j=0;
			$cont= $datos_radicados->rowcount();
			$cont=$cont-1;
			
			while($field = $datos_radicados->fetch()){ 
			if($i!=$cont)
			{
			  $radicado_cadena =  $radicado_cadena.$field[radicado].",";
			}
			else
			{
			$radicado_cadena =  $radicado_cadena.$field[radicado];
			...
			//echo $radicado_cadena;
			?>
              <?php  
			  
			//print_r($datos_radica);  
			while($field1 = $datos_tutela->fetch()){ 
			
			//echo $field1[Tutela_Incidente];
			
			?>
              <input type="hidden" name="radicado_lista" id="radicados" value="<?php echo $radicado_cadena;?>" />
               <input type="hidden" name="id" id="radicados" value="<?php echo $_GET['nombre'];?>" />
          ...
          <tr>
            ...
            <td><select name="ano" id="sl_input" class="required" onchange="construir_radicado(frm)">
              <option value="<?php echo $datos_radica[0][ano];?>"><?php echo $datos_radica[0][ano];?></option>
          ...
          <tr>
            ...
            <td><label>
              <input name="consecutivo" type="text" id="txt_input_corto" size="8" maxlength="3" minlength="3" class="required number" onchange="construir_radicado(frm)" value="<?php echo $datos_radica[0][consecutivo];?>"/>
            </label></td>
          </tr>
          <tr>
            <td>Proceso:</td>
            <td><label>
              <select name="proceso" id="sl_input">
                <option value="Tutela" <?php 		  
				   if ($field1[Tutela_Incidente]=='Tutela') {?> selected="selected" <?php }?>>Tutela</option>
                <option value="Incidente" <?php 		  
				   if ($field1[Tutela_Incidente]=='Incidente') {?> selected="selected" <?php }?> >Incidente</option>
              </select>
            </label></td>
          </tr>
          <tr>
            ...
            <td><label>
              <select name="instancia" id="sl_input" class="required" onchange="construir_radicado(frm)">
                <option option value="<?php echo $datos_radica[0][instancia];?>"><?php echo $datos_radica[0][instancia];?></option>
          ...
          <tr>
            ...
            <option value="<?php echo $field1[juzgado] ?>" selected="selected"><?php echo $field1[nombre] ?></option>
 ...
 ?>
          ...
          <tr>
            <td>Radicado</td>
            <td> <input name="radicado" type="text" class="required" id="txt_input" size="23" maxlength="23" minlength="23" readonly="readonly" value="<?php echo $field1[radicado];?>" /></td>
          </tr>
          <tr>
      ...
      $fecha=date('Y-m-d');?>
       ...
       <?php }?>
          <tr>
            <td>&nbsp;</td>
            <td><input type="button" name="Submit" value="Actualizar" id="btn_input" onclick="validar_ex(frm)"></td>
          </tr>
        </table>
      </form>
    </div></td>
