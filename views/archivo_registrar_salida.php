...
<table border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td style="background:url(views/images/crm_fondo_body.png) repeat-y;"><div id="contenido">
      <form id="frm" name="frm" method="post" enctype="multipart/form-data" action="">
        <div id="titulo_frm">Registrar Salida de Expediente</div>
      ...
      $fecha=date('Y-m-d');?>
          ...
          <tr>
             ...
             <td><input type="text" name="cedula_demandante" id="txt_input" maxlength="1000" class="" readonly="readonly" value="<?php echo $field[cedula_demandante]; ?>" /></td>
             
             </tr>
             <tr>
             <td>Nombre Demandante: </td>
             <td><input type="text" name="demandante" readonly="readonly" id="txt_input" maxlength="1000" class=""  onchange="" value="<?php echo $field[demandante]; ?>"/></td>
             </tr>
             <tr>
             <td>Cédula Demandado: </td>
             <td><input type="text" name="cedula_demandado" readonly="readonly" id="txt_input" maxlength="1000" class=""  onchange="" value="<?php echo $field[cedula_demandado]; ?>"/></td>
             </tr>
             <tr>
             <td>Nombre Demandado: </td>
             <td><input type="text" name="demandado" readonly="readonly" id="txt_input" maxlength="1000" class=""  onchange="" value="<?php echo $field[demandado]; ?>"/></td>
             </tr>           
          ...
          <td>Estado:</td><input name="estado" type="hidden" value=<?php echo $fielde[idestado];?>/>
          ...
          <tr>
            <td colspan="2" bgcolor="#CDE3F6"><div align="center"><strong>DETALLE SALIDA</strong></div></td>
            </tr>
          <tr>
          <td>Fecha de Salida:</td>
          <td><input name="fechasalida" type="text" class="required tinicio" id="txt_input" readonly="readonly" value="<?php echo $fecha;?>"/>
          ...
          <tr>
          <td>Juzgado de Destino:</td>
          <td><select name="idjuzdes" class="required" id="sl_input" onchange="">
 ...
 ?>
		  ...
		  <tr>
             <td>Observaciones: </td>
           <td><textarea name="observacion_salida" id="txt_input" cols="45" rows="5" maxlength = "1000" ><?php echo $field[observacion_salida] ;?></textarea> </td>
		  </tr>
