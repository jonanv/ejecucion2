...
<div id="titulo_frm">Consultar Acta Saliente</div>
...
while($field = $datos_inventario->fetch()){?>
  ...
  <tr>
    ...
    <td width="150"><div id="txtnegro">Consecutivo Acta Recibida:</div></td>
  ...
  <tr>
    <td><div id="txtnegro">Juzgado Destino</div></td>
    <td><?php echo $field[destino];?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
?></td>
  ...
  <tr>
    <td colspan="4"><div align="center" style="background:#CCCCCC"><strong>DATOS ACTA DE ENTREGA</strong></div></td>
    </tr>
  <tr>
    <td><div id="txtnegro">Consecutivo Acta Entrega:</div></td>
    <td><?php echo $field[consecutivo_acta_entrega];?></td>
    <td><div id="txtnegro">Fecha Entrega:</div></td>
    <td><?php echo $field[fecha_entrega];?></td>
  </tr>
  <tr>
    <td><div id="txtnegro">Nombre Entrega:</div></td>
    <td><?php echo $field[nombre_entrega_acta];?></td>
    <td><div id="txtnegro">Nombre Recibe:</div></td>
