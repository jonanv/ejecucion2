...
<table border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td style="background:url(views/images/crm_fondo_body.png) repeat-y;"><div id="contenido">
      <form id="frm" name="frm" method="post" action="">
        <div id="titulo_frm">Entregar Acta</div>
 ...
 ?>
                        <tr>
                          <td colspan="3"><div align="center" style="background:#CCCCCC"><strong>DATOS ACTA DE RECIBIDO</strong></div></td>
                        </tr>
            <tr>
          ...
          <tr>
            <td>Fecha Recibido Acta:</td>
            <td colspan="2"><input name="fecha_acta" type="text" class="required tinicio" id="txt_input" readonly="readonly" value="<?php echo $fieldi[fecha_acta];?>" onchange="validar_fecha(frm)" disabled="disabled"/>
	<script type="text/javascript" charset="utf-8">
          ...
          <tr>
            <td>Juzgado:</td>
            <td colspan="2"><select name="idjuzgado" class="required" id="txt_input" onchange="construir_radicado(frm)" disabled="disabled">
 ...
 ?>
          ...
          <tr>
            <td>Consecutivo Acta Recibido:</td>
            <td colspan="2"><input type="text" name="consecutivo_acta" id="txt_input" value="<?php echo $fieldi[consecutivo_acta];?>" class="required" disabled="disabled"/></td>
          </tr>
          <tr>
            <td>Responsable:</td>
 ...
 ?>
            ...
            <td colspan="2"><label>
             ...
             <tr>
               ...
               <td colspan="-1"><input name="prestados" type="checkbox" id="prestados" value="1" onclick="validar_prestamo(frm)"      <?php  if($fieldi[cantidad_expedientes_prestados]>0){?> checked="checked" disabled="disabled" /><?php }?></td>
             </tr>
             <tr>
               <td>Cantidad Expedientes Prestados:</td>
               <td colspan="-1"><input type="procesos" name="cantidad_prestamo" id="txt_input12" class="required number" value="<?php echo $fieldi[cantidad_expedientes_prestados]; ?>" disabled="disabled" /></td>
             </tr>
             <tr>
               <td>A Quien Presto:</td>
               <td colspan="-1"><input type="text" name="nombre_prestamo" id="txt_input" class="required" value="<?php echo $fieldi[persona_presto]; ?>"  disabled="disabled"/></td>
             </tr>
             <tr>
               <td>Observaciones Pr&eacute;stamo:</td>
               <td colspan="-1"><textarea name="observaciones_prestamo" id="txt_input" cols="45" rows="5" disabled="disabled" class="required"><?php echo $fieldi[observaciones_prestamo]; ?></textarea></td>
             </tr>
      ...
      $fechaa=date('Y-m-d');?>
            <td colspan="2"><input name="fecha_entrega" type="text" class="required tinicio" id="txt_input" readonly="readonly" value="<?php echo $fechaa;?>" onchange="validar_fecha(frm)" />
	<script type="text/javascript" charset="utf-8">
			jQuery(document).ready(function()
			{
			  jQuery(".tinicio").datepicker({ changeFirstDay: false	});
          ...
          <tr>
            ...
            <td colspan="2"><input type="text" name="consecutivo_entrega" id="txt_input" value="<?php echo $datos_consecutivo;
          ...
          <tr>
            ...
            <td colspan="2"><input type="text" name="nombre_entrega_acta" id="txt_input" class="required"></td>
          </tr>
          <tr>
            <td>Nombre Recibe:</td>
            <td colspan="2"><input type="text" name="nombre_recibe_acta" id="txt_input" class="required" /></td>
          </tr>
          ...
          <tr>
            <td>&nbsp;</td>
            <td colspan="2"><input type="submit" name="Submit" value="Entregar" id="btn_input">
