...
if(!defined("LAYOUT_SETUP")) 
{
	...
	class layout_setup
	{
		...
		var $calendar_title_text = 'CALENDARIO';
		...
		var $calendar_title_background_color = '800000';
		var $calendar_title_background_image = 'calendario.png';
		var $calendar_title_text_color = 'FFFFFF';
		var $calendar_border_color = 'AAAAAA';
		var $calendar_day_background_color = 'ECECEC';
		var $calendar_today_background_color = 'FFFFFF';
		var $calendar_day_bgmouseover_color = '1180A4';
		var $calendar_day_text_color = '000000';
		var $schedule_one_background_color = 'FFF';
		var $schedule_two_background_color = 'D6D6D6';
		var $schedule_border_color = '000000';
		var $schedule_text_color = '#000000';
		var $schedule_time_background_color = '1180A4';
		var $schedule_time_text_color = 'FFF';
