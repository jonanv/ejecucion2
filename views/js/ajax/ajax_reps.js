$(function(){
	...
	$(".generarword").click(function(){
	 ...
	 $('#new').click( function(){
		...
		$('#popupbox').load('views/popupbox/reps_permisos.php',params,function(){
			//alert(2);
			$('#block').show();
			//alert(3);
			$('#popupbox').show();
...
function Reporte_Excel(idreporte){
	...
	if(idreporte == 2){
		...
		location.href="index.php?controller=reps&action=ReporteRepsExcel&datos_reporte="+datos_reporte;
	}
