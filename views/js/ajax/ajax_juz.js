$(function(){
	...
	$(".cargar_info_corres").click(function(){
		...
		alert(data_tipodocumento+"/////"+data_juzgadodestino+"/////"+data_solicitud);  
		...
		if(cantidad_filas_2RA > 1){
			...
			$('#t_ra tr').each(function () {
				...
				if(controlemcabezadosRA == 0){
					...
					datospartesRA = datospartesRA+"******"+d0RA+"//////"+d1RA+"//////"+d2RA+"//////"+d3RA+"//////"+d4RA+"//////"+d5RA;
			...
			alert("No es Posible Realizar el Registro, no se Cuenta con Informacion en la TABLA OBSERVACIONES");
			return false;
		}
	...
	$("#frm_RA").validate({
        ...
        submitHandler: function(form){
			...
			var url1       = "index.php?controller=archivo&action=Asignar_Observacion";
			//**********************************************************************************************************
...
function Adicionar_Accion(){
	...
	//VALIDA SI UN RADICADO YA FUE ADICONADO A LA TABLA
	var existenumtitulo_ra = Validar_Radicado_Tabla_RA();
	...
	if(validarcampos_ra == 1){
		...
		validarcampos_ra = 1;
			...
			var dato1_ra = document.getElementById('juz_idradicado').value;
			var dato2_ra = document.getElementById('juz_radicado').value;
			var dato3_ra = document.getElementById('juz_lista_1').value+"-"+$("#juz_lista_1 option:selected").text();
			var dato4_ra = document.getElementById('juz_obs').value;
			
			//var dato5_ra = document.getElementById('juz_fechasri').value;
			//var dato6_ra = document.getElementById('juz_fechasrf').value;
			
			var dato5_ra = $('#fechasr110').val();;
			...
			$.get('views/funciones/traer_fechas_obs.php?fechat='+dato5_ra, function(fechas){
			...
			//PARA QUE CARGEN LAS FECHAS INICIAL Y FINAL EL FIN DEL $.get('views/funciones/traer_fechas_obs.php?fechat='+dato5_ra, function(fechas){
		    //VA AL FINAL DESPUES DE LOS IF DE ADICIONAR A LA TABLA, YA QUE SI SE CIERRA ANTES DA UNA INCOSISTENCIA FECHAS NULAS
			...
			});//FIN DEL $.get('views/funciones/traer_fechas_obs.php?fechat='+dato5_ra, function(fechas){
...
function Validar_Radicado_Tabla_RA(){
	
	var existe = 0;
	
	var datonumero = document.getElementById('juz_idradicado').value;
...
function Validar_Campos_Agregar_RA(){
	...
	valor  = document.getElementById('juz_idradicado').value;
	valor2 = document.getElementById('juz_radicado').value;
	valor3 = document.getElementById('juz_lista_1').value;
	valor4 = document.getElementById('juz_obs').value;
	//valor5 = document.getElementById('juz_fechasri').value;
	//valor6 = document.getElementById('juz_fechasrf').value;
	
	
	if( valor == null || valor.length == 0 || /^\s+$/.test(valor) ) {
  		
		alert("Defina IdRad");
		document.getElementById('juz_idradicado').style.borderColor = '#FF0000';
		validar = 1;
		return validar;
	}
	...
	if( valor == null || valor2.length == 0 || /^\s+$/.test(valor2) ) {
  		
		alert("Defina Radicado");
		document.getElementById('juz_radicado').style.borderColor = '#FF0000';
		validar = 1;
		return validar;
	}
	else{
	...
	if( valor3 == null || valor3.length == 0 || /^\s+$/.test(valor3) ) {
		...
		alert("Defina Asignado A");
		document.getElementById('juz_lista_1').style.borderColor = '#FF0000';
		validar = 1;
		return validar;
	}
	...
	if( valor4 == null || valor4.length == 0 || /^\s+$/.test(valor4) ) {
		...
		document.getElementById('juz_obs').style.borderColor = '#FF0000';
		validar = 1;
		return validar;
	}
	...
	/*if( valor5 == null || valor5.length == 0 || /^\s+$/.test(valor5) ) {
		...
		document.getElementById('juz_fechasri').style.borderColor = '#FF0000';
		validar = 1;
		return validar;
	}
	...
	if( valor6 == null || valor6.length == 0 || /^\s+$/.test(valor6) ) {
		...
		document.getElementById('juz_fechasrf').style.borderColor = '#FF0000';
		validar = 1;
		return validar;
	}*/
...
function Limpiar_Campos_3_RA(){
	...
	document.getElementById('juz_idradicado').value = "";
	document.getElementById('juz_idradicado').style.borderColor='#E0E0E0';
	
	document.getElementById('juz_radicado').value = "";
	document.getElementById('juz_radicado').style.borderColor='#E0E0E0';
	
	document.getElementById('juz_lista_1').selectedIndex = 0;
	document.getElementById('juz_lista_1').style.borderColor='#E0E0E0';
	
	document.getElementById('juz_obs').value = "";
	document.getElementById('juz_obs').style.borderColor='#E0E0E0';
	
	//document.getElementById('juz_fechasri').value = "";
	//document.getElementById('juz_fechasri').style.borderColor='#E0E0E0';
	
	//document.getElementById('juz_fechasrf').value = "";
	//document.getElementById('juz_fechasrf').style.borderColor='#E0E0E0';
