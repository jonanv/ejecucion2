$(function () {
		...
		if (cantidad_filas_2 > 1) {
			...
			$('#t tr').each(function () {
				...
				if (controlemcabezados == 0) {
					...
					datospartes = datospartes + "******" + d0 + "//////" + d1 + "//////" + d2 + "//////" + d3 + "//////" + d4 + "//////" + d5 + "//////" + d6 + "//////" + d7 + "//////" + d8 + "//////" + d9 + "//////" + d10 + "//////" + d11;
	...
	$("#frm").validate({
		...
		messages: {
			...
			/*lastname: "Debe introducir su apellido.",
			 ...
			 phone : "El n�mero de tel�fono introducido no es correcto.",
			 years : "Debe introducir solo n�meros.",
		...
		submitHandler: function (form) {
			...
			var url1 = "index.php?controller=archivo&action=Registrar_Ejecutoria";
			//**********************************************************************************************************
	...
	//------------------------MANEJO AUDIENCIAS PARA CALENDARIO----------------------
	//ADICIONADO 13 DE FEBRERO 2019

	$('#filaaudi').hide();

	$("#obserie").change(function (event) {

		$("#fechaaudi").val('');
		$("#horaaudi").val('');
		$("#obsaudi").val('');

		var idOBS = $("#obserie").find(':selected').val();
		//alert(idOBS);
	...
	//------------------------FIN MANEJO AUDIENCIAS PARA CALENDARIO--------------------
...
function Adicionar_Parte(idaccion, idmemorial) {
	...
	if (existenumtitulo == 1) {
		...
		if (validarcampos == 1) {
			...
			//var dato3 = document.getElementById('obserie').value;

			var s0 = document.frm.obserie;
			var dato3 = s0.options[s0.selectedIndex].text;

			var idOBS_2X = $("#obserie").find(':selected').val();
			var a_despacho = 0;

			//PASA A MEMORIALES DEL JUZGADO PRIMERO DE EJECUCION / PASA A MEMORIALES DEL JUZGADO SEGUNDO DE EJECUCION
			if (idOBS_2X == 6 || idOBS_2X == 7) {

				dato3 = s0.options[s0.selectedIndex].text + " " + $("#obsadicional").val().trim();

				a_despacho = 1;
			}

			if (idOBS_2X != 6 && idOBS_2X != 7 && idOBS_2X != 18) {
			...
			//alert(dato3);
			//if(dato3 == "PASA PARA UBICAR EN JUZGADO DE ORIGEN" || dato3 == "PASA AL AREA DE ARCHIVO"){
			if (dato3 == "PASA PARA UBICAR EN JUZGADO DE ORIGEN") {

				//alert("entre");
				var valorOBS = document.getElementById('posi').value;

				if (valorOBS == null || valorOBS.length == 0 || /^\s+$/.test(valorOBS)) {
					banderaOBS = 1;
				}
				else {

					dato3 = dato3 + ", CAJA ORIGEN: " + valorOBS;
				}
			...
			// var valor1 = document.getElementById('actuacion').value;
			// var s0A = document.frm.actuacion;
			// var valor1B = s0A.options[s0A.selectedIndex].text;
			// var valor1_TOTAl = valor1 + '-' + valor1B;

			var valor2 = document.getElementById('fecha_actusti').value;
			var valor3 = document.getElementById('diasti').value;
			var valor4 = document.getElementById('fecha_actusfti').value;

			var valor5 = document.getElementById('asignadoa').value;
			var s0B = document.frm.asignadoa;
			var valor5B = s0B.options[s0B.selectedIndex].text;
			var valor5_TOTAl = valor5 + '-' + valor5B;
			...
			if (
				...
				(valor5 == null || valor5.length == 0 || /^\s+$/.test(valor5))
			) {

				valor1 = "SIN TRAMITE";
				valor1B = "SIN TRAMITE";
				valor1_TOTAl = "SIN TRAMITE";
				...
				valor5 = "SIN TRAMITE";
				valor5B = "SIN TRAMITE";
				valor5_TOTAl = "SIN TRAMITE";

			}

			//-------------------------------------------------------------------------------------------------------

			var vaudi1 = $("#fechaaudi").val();
			var vaudi2 = $("#horaaudi").val();
			var vaudi3 = $("#obsaudi").val();

			var idOBS_2 = $("#obserie").find(':selected').val();
			...
			if (idOBS_2 == 18) {
				...
				if (
					(vaudi1 == null || vaudi1.length == 0 || /^\s+$/.test(vaudi1)) ||
					(vaudi2 == null || vaudi2.length == 0 || /^\s+$/.test(vaudi2)) ||
					(vaudi3 == null || vaudi3.length == 0 || /^\s+$/.test(vaudi3))

				) {

					alert("SE SELECCIONO EN LA LISTA OBSERVACION, AUDIENCIA, SE DEBE DEFINIR, FECHA, HORA Y OBSERVACION AUDIENCIA");
					document.getElementById('fechaaudi').style.borderColor = '#FF0000';
					document.getElementById('horaaudi').style.borderColor = '#FF0000';
					document.getElementById('obsaudi').style.borderColor = '#FF0000';
...
function Limpiar_Campos() {
	...
	document.getElementById('radicado').value = "170014003";
	...
	// document.getElementById('actuacion').style.borderColor = '#E0E0E0';

	//document.getElementById('fecha_actusti').value= "";
	//document.getElementById('fecha_actusti').style.borderColor='#E0E0E0';

	document.getElementById('diasti').value = "";
	document.getElementById('diasti').style.borderColor = '#E0E0E0';

	document.getElementById('fecha_actusfti').value = "";
	document.getElementById('fecha_actusfti').style.borderColor = '#E0E0E0';

	document.getElementById('asignadoa').value = "";
	document.getElementById('asignadoa').style.borderColor = '#E0E0E0';


	document.getElementById('fechaaudi').value = "";
	document.getElementById('fechaaudi').style.borderColor = '#E0E0E0';

	document.getElementById('horaaudi').value = "";
	document.getElementById('horaaudi').style.borderColor = '#E0E0E0';

	document.getElementById('obsaudi').value = "";
	document.getElementById('obsaudi').style.borderColor = '#E0E0E0';


	document.getElementById('obsadicional').value = "";
	document.getElementById('obsadicional').style.borderColor = '#E0E0E0';
