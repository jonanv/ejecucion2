$(function(){
    ...
    $("#frm").validate({
        ...
        submitHandler: function(form){
			...
			//**********************************************************************************************************
			var dataString = 'yeararchivo='+$('#yeararchivo').val()+'&datospartes='+$('#datospartes').val()+'&cajaarchivo='+$('#cajaarchivo').val();
			var url1       = "index.php?controller=administrar&action=Administrar_Archivo";
			//**********************************************************************************************************
            ...
            $.ajax({
                ...
                success: function(data){
				   ...
				   if(cadenadatos[0] == 'CORRECTO'){
						...
						location.href="index.php?controller=administrar&action=Administrar_Archivo";
