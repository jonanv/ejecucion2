...
function Reporte_Excel(idreporte){
	...
	if(idreporte == 1){
		...
		if (document.formp.usuario.value.length == 0 && document.formp.fechad.value.length == 0 && document.formp.fechah.value.length == 0 && document.formp.estado.value.length == 0){
			...
			location.href="index.php?controller=reps&action=ReporteRepsExcel&datos_reportepermiso="+datos_reportepermiso;
		}
	...
	if(idreporte == 3){
		...
		if (
			...
			document.formp.usuario.value.length == 0 && ( document.formp.fechad.value.length   == 0 && document.formp.fechah.value.length   == 0 )
		){
		
			alert("Definir Algun Campo para Realizar el Filtro, Menos Estado Para este Reporte");
			document.getElementById('usuario').style.borderColor='#FF0000';
			document.getElementById('fechad').style.borderColor='#FF0000';
			document.getElementById('fechah').style.borderColor='#FF0000';
			//document.getElementById('estado').style.borderColor='#FF0000';
			...
			location.href="index.php?controller=reps&action=ReporteRepsExcel&datos_reportecompletosalidaentrada="+datos_reportecompletosalidaentrada;
