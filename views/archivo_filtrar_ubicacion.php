...
$(document).ready(function() {
	...
	//PARA LAS FECHAS
	$("#fechair").datepicker({ changeFirstDay: false, dateFormat: 'yy-mm-dd'	});
	$("#fechafr").datepicker({ changeFirstDay: false, dateFormat: 'yy-mm-dd'	});
	$("#fechaoi").datepicker({ changeFirstDay: false, dateFormat: 'yy-mm-dd'	});
	$("#fechaof").datepicker({ changeFirstDay: false, dateFormat: 'yy-mm-dd'	});
	$("#fechai").datepicker({ changeFirstDay: false, dateFormat: 'yy-mm-dd'	});
	$("#fechaf").datepicker({ changeFirstDay: false, dateFormat: 'yy-mm-dd'	});
	
	
	$("#fechaiRM").datepicker({ changeFirstDay: false, dateFormat: 'yy-mm-dd'	});
	$("#fechafRM").datepicker({ changeFirstDay: false, dateFormat: 'yy-mm-dd'	});
	$("#fechati").datepicker({ changeFirstDay: false, dateFormat: 'yy-mm-dd'	});
	$("#fechatf").datepicker({ changeFirstDay: false, dateFormat: 'yy-mm-dd'	});
	$("#fechaiv").datepicker({ changeFirstDay: false, dateFormat: 'yy-mm-dd'	});
	$("#fechafv").datepicker({ changeFirstDay: false, dateFormat: 'yy-mm-dd'	});
	
	
	
	
	
	$("#fecha1hcet").datepicker({ changeFirstDay: false, dateFormat: 'yy-mm-dd'	});
	$("#fecha2hcet").datepicker({ changeFirstDay: false, dateFormat: 'yy-mm-dd'	});
	
	$("#fecha1soli").datepicker({ changeFirstDay: false, dateFormat: 'yy-mm-dd'	});
	$("#fecha2soli").datepicker({ changeFirstDay: false, dateFormat: 'yy-mm-dd'	});
...
if($_SESSION['idUsuario']==8 || $_SESSION['idUsuario']==38 || $_SESSION['idUsuario'] == 78 || $_SESSION['idUsuario']==19 || $_SESSION['idUsuario']==4 || $_SESSION['idUsuario']==83){ 
...
<table border="0" cellspacing="0" cellpadding="0" id="frm_editar">
	...
	<tr>
		...
		<td colspan="4" bgcolor="#CDE3F6"><div align="center"><strong>FILTRO DE OBSERVACIONES</strong></div></td>
    ...
    <strong><tr>
            <td colspan="4" bgcolor="#CDE3F6"><div align="center"><strong>PARTES</strong></div></td>
            </tr></strong>
    <tr>
      ...
      <tr>
            <td colspan="4" bgcolor="#CDE3F6"><div align="center"><strong>UBICACI&Oacute;N</strong></div></td>
            </tr>  
      <tr>
      <td>Radicado:</td>
	 ...
	 ?>
      ...
      <td colspan="2"><select name="idusuario" id="idusuario"  >
	   ...
	   <tr>
            <td colspan="4" bgcolor="#CDE3F6"><div align="center"><strong>REPARTO</strong></div></td>
       </tr>
       ...
       <tr>
		...
		<!-- REPARTO MASIVO -->	
			<?php if ( in_array($_SESSION['idUsuario'],$usuariosaAR2,true) ){ /*if($_SESSION['idUsuario']==38 || $_SESSION['idUsuario']==51){*/ ?>
			 ...
			 <tr>
            	<td colspan="4" bgcolor="#CDE3F6"><div align="center"><strong>REPARTO MASIVO</strong></div></td>
       		</tr>
								...
								<thead> 
											<tr>
												<th bgcolor="#CDE3F9" colspan="11">
													<center><div id="titulo_frm"><?php echo $registros_masivos." PROCESOS / F. INICIAL:".$firm." F. FINAL:".$ffrm ; ?></div></center>
												</th>
											</tr>
											<tr> 
												<th>ID</th>
										...
										<tbody> 
											...
											<?php $Cr=1; while($rowr = $datos_reparto->fetch()){ ?>
   ...
   <tr>
   		<td colspan="4" bgcolor="#CDE3F6"><div align="center"><strong>TR�MITE INTERNO</strong></div></td>
   </tr>
   ...
   <tr>
   		<td colspan="4" bgcolor="#CDE3F6"><div align="center"><strong>CONSULTA EN VENTANILLA DE PROCESOS</strong></div></td>
   </tr>
   ...
   <tr>
		...
		<table cellpadding="0" cellspacing="0" border="1" class="display" id="tramite">
			...
			<?php //while($row = $datos_actuaciones->fetch()){ ?>
					...
					<tr>
						...
						<td><?php //echo $row[actu_fechaf];?></td>
						<td><?php //echo $row[empleado];?></td>
						<td><?php //echo $row[acc_descripcion];?></td>
					</tr>
    ...
    <!-- --------------------------------------------------------------------------------------------------------------------------------------------------------- -->
   		...
   		<tr>
            <td colspan="4" bgcolor="#CDE3F6"><div align="center"><strong>T&Iacute;TULOS</strong></div></td>
        </tr>
	   ...
	   <tr>
            <td colspan="4" bgcolor="#CDE3F6"><div align="center"><strong>HOJA CONTROL DE ENTREGA DE TITULOS</strong></div></td>
       </tr>
	   ...
	   <?php if ( $banderaREVS == 1 ){ ?>
	    ...
	    <tr>
            <td colspan="4" bgcolor="#CDE3F6"><div align="center"><strong>REPORTES SIN FILTRO</strong></div></td>
       </tr>
	   ...
	   <tr>
            <td colspan="4" bgcolor="#CDE3F6"><div align="center"><strong>REPORTES</strong></div></td>
       </tr>
	   ...
	   <!-- TERMINOS -->	
							...
							<table cellpadding="0" cellspacing="0" rules="rows" border="1" class="display" id="frm_tramite_interno">
								...
								<thead> 
										...
										<tbody> 
											...
											<?php $Ci=1; while($row = $datosproceso->fetch()){ ?>
		...
		<tr>
			...
			<td colspan="4">
				...
				<!-- <marquee behavior="alternate" bgcolor="#EFEFEF" scrollamount="2" scrolldelay="10" width="450" height="20">ALERTA VISUALIZAR REMATE SIN APROBAR, CANTIDAD: <?php //echo $cantregisrema; ?></marquee> -->
								...
								<thead> 
											<tr>
												<th bgcolor="#CDE3F9" colspan="16">
													<center><div id="titulo_frm"><?php echo strtoupper($titulo2); ?></div></center>
												</th>
											</tr>
											<tr> 
												<th>ID</th>
                ...
                <thead>
  				...
  				<tbody>       
					...
					<tr>
							...
							<!-- <td><?php //echo $band= $field[fechasalida];?></td>  -->
							<td><?php if($field[fechasalida] == '' || $field[fechasalida] == '0000-00-00'){echo $band= '';}else{ echo $band= $field[fechasalida];}?></td> 
					...
					?>
					 ...
					 <td></td>
					 <td></td>
					 <!-- <td><a name="<?php //echo "nuevaOBS".$Co;?>" id="<?php //echo "nuevaOBS".$Co;?>" title="<?php //echo "nuevaOBS".$Co;?>" onclick="Obtener_Fila_Tabla(this.parentNode.parentNode.rowIndex)" href="javascript:void(0);" data-radicado_obs="<?php //echo trim($field[radicado]);?>"><img src="views/images/nuevaobs.png" width="30" height="30"/></a> </td> -->
					 
					 <!-- <td><a id="nuevaOBS" name="nuevaOBS" href="javascript:void(0);" data-radicado_obs="<?php //echo trim($field[radicado]);?>"><img src="views/images/nuevaobs.png" width="30" height="30"/></a></td> -->
					 
					 <!-- <td><img id="nuevaOBS" name="nuevaOBS" src="views/images/nuevaobs.png" width="30" height="30" data-radicado_obs="<?php //echo trim($field[radicado]);?>"/></td> -->
					 
					 <!-- <td><span style="cursor:pointer"><img src="views/images/new3.jpg" width="30" height="30" alt="" title="Adicionar Observacion" onclick="Adicionar_Observacion(<?php //echo $field[id];?>)"/></span></td> -->
...
<table cellpadding="0" cellspacing="0" rules="rows" border="1" class="display" id="frm_editar2">
			   ...
			   <td><span style="cursor:pointer"> 
							...
							<!-- <td><span style="cursor:pointer"><img src="views/images/new3.jpg" width="30" height="30" alt="" title="Adicionar Observacion" onclick="Adicionar_Observacion(<?php //echo $field[idubi];?>)"/></span></td> -->
				  </tr>
