...
{
variable=1;
variable1=frm.fecha.value;
//alert(variable1);

location.href="index.php?controller=archivo&action=ReporteProduccionDiaria1&nombre="+variable+"&nombre1="+variable1;
...
<div id="titulo_frm">Reporte Producción Diaria</div>
<table border="0" cellspacing="0" cellpadding="0" id="frm_editar">
    <tr>
      <td>Seleccione la fecha</td>
      <td><input name="fecha" type="text" class="required tinicio" id="txt_input" readonly="readonly"/>
   ...
   <tr>
    <td>&nbsp;</td>
    <td><input type="button" name="Submit" value="Consultar" id="btn_input" onclick="vinculo(frm)">
