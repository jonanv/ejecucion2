  ...
  <tr>
    <td ><div id="contenido">
      <form id="frm" name="frm" method="post" action="">
        <div id="titulo_frm">Registrar Documentos</div>
...
?>
    <td width="501"><input name="fecha" type="text" class="required tinicio" id="txt_input" readonly="readonly" value="<?php echo  $fechaa;?>"/>	</td>
             ...
             <tr>
               ...
               <td><input name="consecutivo" type="text" id="txt_input_corto" size="8" maxlength="3" minlength="3" class="required number" onchange="construir_radicado(frm)" disabled="disabled"/>
 ...
 ?>
                   <option value="<?php echo $fields[id]."-".$fields[idprioridad];?>" ><?php echo $fields[nombre] ?></option>
                   <?php }?>
                 </select>
               </label></td>
             </tr>
             <tr>
               <td>Prioridad:</td>
               <td><input type="text" name="prioridad" id="txt_input" readonly="readonly" /></td>
             </tr>
             <tr>
               <td>Peticionario:</td>
               <td>
             ...
             <tr>
               <td>C&eacute;dula:</td>
               <td><input type="text" name="txt_input" id="txt_input"  /></td>
             </tr>
             <tr>
             ...
             <tr>
               <td>Folios:</td>
               <td>
                 <input type="text" name="folios" id="txt_input7" class="required number" />             </td>
             </tr>
             <tr>
               <td>Recibe:</td>
