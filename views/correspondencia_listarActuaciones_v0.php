...
order by ct.radicado,av.accionante_accionado_vinculado ",$cn);
                ...
                <thead>
                  ...
                  <tbody>
                   ...
                   while($reg=  mysql_fetch_array($listado))
                   {
							   ...
							   echo '<td style="cursor:pointer"><img src="views/images/edit.png" width="21" height="23" onclick="vinculo('.$reg['id'].')" title="Modificar Actuaci&oacute;n">'.'</td>';
							    echo '<td style="cursor:pointer"><img src="views/images/elim.png" width="21" height="23" onclick="vinculo1('.$reg['id'].')" title="Eliminar Actuaci&oacute;n">'.'</td>';
                               echo '</tr>';
