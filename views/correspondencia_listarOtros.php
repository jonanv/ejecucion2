...
<div id="titulo_frm">Lista de Correspondencias Otros</div>
  ...
  <tr>
	...
	<td><?php echo $field[juzgadonom];?></td>
	 <td><?php echo $field[destinatario];?></td>
	    ...
	    <td></td>
	    <td><span style="cursor:pointer"><img src="views/images//list.png" width="21" height="23" onclick="vinculo(<?php echo $field[corresid];?>)" title="Consultar Correspondencia"/></span></td>
	    <td><span style="cursor:pointer"><img src="views/images/edit.png" alt="" width="21" height="23" title="Modificar Correspondencia" onclick="vinculo1(<?php echo $field[corresid];?>)"/></span></td>
  </tr>
<?php  }?>
  </tbody>
  </table>
