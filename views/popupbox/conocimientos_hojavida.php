...
//LISTA CONOCIMENTOS
$datos_conocimientos = $funcion->get_lista_estudios($id_hv,'C')
...
<script type="text/javascript">
	...
	function Registrar_Experiencia(){	
	    ...
	    var TABLA_2_es      = document.getElementById('t_co_hv');
		...
		if(cantidad_filas_2_es > 1){
			...
			msg = "NO ES POSIBLE REALIZAR EL REGISTRO NO SE CUENTA CON INFORMACION EN LA TABLA CONOCIMIENTOS";
		...
		if(validar == 0){
			...
			$.ajax({
				...
				url:'index.php?controller=hojavida&action=Administrar_HojaVida_Conocimientos',
	...
	$(".boton_editar").click(function(){
				...
				var cantidad_filas_F;
				var TABLA_F = document.getElementById('tabla_conocimiento');
				...
				for (r = 2; r < cantidad_filas_F; r++){
					...
					d0  = document.getElementById("tabla_conocimiento").rows[r].cells[0].innerText;
					...
					if($("#chk"+f).is(':checked')) {  
							...
							d0xe  = document.getElementById("tabla_conocimiento").rows[r].cells[0].innerText;
							
							d1xe  = document.getElementById("tabla_conocimiento").rows[r].cells[1].innerText;
	...
	function Adicionar_Experiencia(){
		...
		if(validarcampos == 1){
			...
			validarcampos = 1;
				...
				Filas = 1;
				var cantidad_filas;
				var TABLA      = document.getElementById('t_co_hv');
				...
				if(cantidad_filas>1){
					...
					var tabla=document.getElementById('cont_co_hv').innerHTML;
					...
					//for (var id=0; id<Filas; id++){
						...
						document.getElementById('cont_co_hv').innerHTML=tabla;
...
<!-- <form method="post" name ="formarchivo" id="formarchivo">  -->
	...
	<table border="3" align="center" style="width:700px">
		...
		<tr>
			<td align="center" colspan="2" style="width:180px; height:23px; border-color:#0100000; color:#FF0000; font-size:16px ">CONOCIMIENTOS</td>
		</tr>
		...
		<tr>
			...
			<td>
				<label style="width:151px; color:#666666">Conocimiento:</label>
			</td>
			<td>
		...
		<tr>
			...
			<td colspan="2">
				...
				<button type="button" name="boton_adicionar_estudio" id="boton_adicionar_estudio" style="float:right" title="ADICIONAR CONOCIMIENTO" onClick="Adicionar_Experiencia()"><img src="views/images/new4.jpg" width="35" height="35"/></button>
																
			</td>
								
		</tr> 
		
		<!-- TABLA PARA ADICIONAR CONOCIMIENTO -->
	...
	<!-- CONOCIMiENTO -->
	<table border="3" align="center" id="tabla_conocimiento" style="width:700px">
		...
		<?php 
			...
			$datosXPE    = explode("*/-*/-",$datos_conocimientos); 
