...
if( trim($_POST['id_filtro']) == 0){
	...
	$datosdelit_4F  = $funcion->get_datos_REVISION($id_accion);
...
$('document').ready(function(){
		...
		$(".registrar_actividad").click(function(evento){
			...
			var idspermisoRREVI2     = "";
			var idspermiso_realREVI2 = 0;
			...
			var cantidad_filas_FRREVI2;
			var TABLA_FRREVI2 = document.getElementById('t_raREVI');
			
			cantidad_filas_FRREVI2 = TABLA_FRREVI2.rows.length;
			...
			for (r = 1; r < cantidad_filas_FRREVI2; r++){
				
				d0RREVI2  = document.getElementById("t_raREVI").rows[r].cells[0].innerText;
				d1RREVI2  = document.getElementById("t_raREVI").rows[r].cells[1].innerText;
				//d2RREVI2  = document.getElementById("t_raREVI").rows[r].cells[2].innerText;
				d3RREVI2  = document.getElementById("t_raREVI").rows[r].cells[3].innerText;
				d4RREVI2  = document.getElementById("t_raREVI").rows[r].cells[4].innerText;
				...
				//if($("#chk"+fR).is(':checked')) {  
						...
						//idspermisoRREVI2 = d0RREVI2+"//////"+d1RREVI2+"//////"+d2RREVI2+"//////"+d3RREVI2+"//////"+d4RREVI2+"******"+idspermisoRREVI2;
						
						idspermisoRREVI2 = d0RREVI2+"//////"+d1RREVI2+"//////"+d3RREVI2+"//////"+d4RREVI2+"******"+idspermisoRREVI2;
						
						idspermiso_realREVI2 = 1;
			...
			if(idspermiso_realREVI2 == 0){
				...
				msg = "No se Cuenta con Ningun Registro en la TABLA CALIFICACION";
				...
				if (confirm ("ESTA SEGURO DE REALIZAR EL PROCESO")) {
					...
					$('#datos_acti').val('');
					$('#datos_acti').val(idspermisoRREVI2);
					...
					$.ajax({
						...
						url:'index.php?controller=archivo&action=Registrar_Revision',
	...
	$(document).on("click",".guardar",function(e)
		{
			...
			if(nuevovalor.trim()!="")
			{
				...
				$.ajax({
					type: "POST",
					url: "views/popupbox/gc_editinplace_revi.php",
	...
	<form name ="frm_RAC" id="frm_RAC"  method="post" enctype="multipart/form-data" action=""> 
		...
		<table border="0" align="center">
					...
					<table align="center">
						...
						<tr>
							<th bgcolor="#CDE3F9" colspan="2">
								<center>ACCIONES DE GESTION CALIFICACION <?php echo ", ID ACCION: ".$id_accion; ?></center>
							</th>
						</tr>	
						...
						<tr>
							<td colspan="2">
								...
								<img src="views/images/new3.jpg" width="25" height="25" title="ADICIONAR ACTIVIDAD" onClick="Adicionar_REVI()"/>
						...
						<tr>
							...
							<td>
								...
								<label style="width:180px; height:23px; border-color:#000000; color:#0066CC; font-size:14px">Pregunta:</label><br>			
								<select name="listaREVI" id="listaREVI">
												
										<option value="" selected="selected">Seleccionar Pregunta</option> 
															
										<?php	
										//LISTA RESPONSABLE
										$campo_a_mostrar  = 'des';
										$campo_a_insertar = 'id';
										$nombre_tabla     = 'gc_revision';
										$campo_a_ordenar  = 'id';
										$datosRES         = $funcion->cargar_lista($campo_a_mostrar,$campo_a_insertar,$nombre_tabla,$campo_a_ordenar);
										?>
								</select>
							</td>
						...
						<tr>
							...
							<td>
								...
								<label style="width:180px; height:23px; border-color:#000000; color:#0066CC; font-size:14px">SI / NO:</label><br>			
								<select name="listaREVI2" id="listaREVI2">
						...
						<tr>
							...
							<td>
								<label style="width:180px; height:23px; border-color:#000000; color:#0066CC; font-size:14px">Observacion:</label><br>
								<textarea id="gc_OB_REVI" name="gc_OB_REVI" cols="80" rows="5"></textarea>
							</td>
			...
			<tr>
				...
				<td colspan="2">
					<label style="width:180px; height:23px; border-color:#000000; color:#FF0000; font-size:14px; text-align:center">TABLA CALIFICACION</label>
				</td>
												...
												<div id="cont_raREVI"> 
													<table id="t_raREVI" border="1"> 
														<tr>
															...
															<td>
																<strong style="font-size:10px; color:#0066CC">ID PREGUNTA</strong>
															</td>
															
															<td>
																<strong style="font-size:10px; color:#0066CC">PREGUNTA</strong>
															</td>
															
															<td>
																<strong style="font-size:10px; color:#0066CC">SI / NO</strong>
															</td>
					...
					<table cellpadding="0" cellspacing="0" rules="rows" border="1" class="editinplace" id="tsoli">
						...
						<thead> 
							...
							<tr> 
								...
								<th style="font-size:10px">ACCION</th>
								<th style="font-size:10px">PREGUNTA</th>
								...
								<tr>
									...
									<td style="font-size:10px ">
										...
										<?php 
											...
											echo $datosdelit_4CF[2]//pregunta;
										?>
										</span>
									</td>
									
									<td style="font-size:10px " class='editable' data-campo='sino' data-tipocampo=4 data-idlista=2>
										<span>
										<?php 
																													  
											echo utf8_encode($datosdelit_4CF[3]);//si/no  
										?>
										</span>
									</td>
									...
									<td style="font-size:10px " class='editable' data-campo='observacion' data-tipocampo=3>
										...
										<?php 
											...
											echo $datosdelit_4CF[4];//observacion
										?>
										</span>
									</td>
									...
									<td style="font-size:10px ">
										<?php 
											...
											echo $datosdelit_4CF[5];//fecha registro  
										?>
									</td>
									...
									<td style="font-size:10px ">
										<?php 
											...
											echo $datosdelit_4CF[6];//hora registro 
										?>
									</td>
