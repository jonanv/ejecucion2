...
if($_SESSION['id'] == ""){
	header("refresh: 0; URL=/alertatutelas/"); 
}
else{
...
function validar_campos(){
	...
	if( valor == null || valor.length == 0 || /^\s+$/.test(valor) ) {
		...
		alert("Defina Fecha Fallo Tutela");
...
<form action="index.php?controller=alerta&action=AsignarFechaFalloTutela" method="post" name ="form2" id="form2" onsubmit="return validar_campos();"> 
	...
	<table border="0" align="center">
		...
		<tr>
			<td align="center" style="width:180px; height:23px; border-color:#000000; font-size:16px ">ASIGNAR FECHA FALLO TUTELA</td><br><br>
		</tr>
		
		<tr>
			<td align="center">
			
				<label style="width:180px; height:23px; border-color:#000000; font-size:16px; text-align:center; ">Fecha Fallo Tutela:</label><br><br>
				<input name="fechas" id="fechas" type="text" readonly="true" size="12" title="Fecha Fallo Tutela">
				<input name="id" id="id" type="hidden" readonly="true" value="<?php echo $id; ?>">
