		...
		//echo $tamano_archivo;
			...
			|| strpos($tipo_archivo, "png") //png
				...
				echo '<script languaje="JavaScript"> 
							...
							alert("El Archivo no Cumple con las Caracteristicas Especificas, si es diferente de tipo (vnd.ms-excel,vnd.openxmlformats-officedocument.spreadsheetml.sheet, vnd.openxmlformats-officedocument.wordprocessingml.document,pdf,jpeg,png) y tama�o de archivo < 100000000.");
