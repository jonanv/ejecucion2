...
//El tiempo de ejecuci�n m�ximo, en segundos. Si se pone a cero se impone sin l�mite de tiempo.
//set_time_limit(0);

//PARA QUE EL REPORTE NO SE CUELGUE Y DE EL MENSAJE
//Error fatal: Memoria insuficiente (asignada 367263744) (intent� asignar 2097152 bytes) 
//en C: \ wamp \ www \ laborales \ views \ PHPExcel-development \ Classes \ PHPExcel \ CachedObjectStorage \ CacheBase.php en la l�nea 173
...
if($opcion == 1){
	...
	//->setCellValue('C1',  utf8_encode('C�dula Demandante')) //PARA LAS TILDES
