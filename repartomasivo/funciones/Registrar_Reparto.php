...
if($conexion > 0){
	...
	while($i<$long){
		...
		//SQL PARA PRUEBAS
		/*$sql = ("UPDATE info1 SET des = 'Actuaci�n Registrada por la Oficina de Ejecuci�n de Sentencias'
			     WHERE radicado ='$d0';
		...
		$sql = ("declare @cad integer 
				...
				UPDATE t103dainfoproc SET a103descacts='Redistribuci�n a Juzgados de Ejecuci�n de Sentencias', a103codiacts='30023582', a103codipads='30011102',
				a103fechdess = GETDATE(), a103anotacts = 'Actuaci�n Registrada por la Oficina de Ejecuci�n de Sentencias',
				...
				A110RENUTERM) values('$d1',@cad,'$sin','00','30023582','30011102','Redistribuci�n a Juzgados de Ejecuci�n de Sentencias','N','NO','N',0,NULL,NULL,GETDATE(),NULL,NULL,NULL,NULL,NULL,
				'Actuaci�n Registrada por la Oficina de Ejecuci�n de Sentencias',NULL,NULL,'S','D',GETDATE(),'NO','NO')");
		...
		//$error_transaccion Y SE EJECUTA sqlsrv_rollback( $conn ) � sqlsrv_commit( $conn )
		//IGUAL QUE EN MySQL
		if( $stmt ) {
			 //sqlsrv_commit( $conn );
		...
		/*$sql1 = "UPDATE info1 SET des = 'Actuaci�n Registrada por la Oficina de Ejecuci�n de Sentencias'
				 WHERE radicado ='$d0'";
		...
		//Si ambas sentencias finalizaran con �xito, consolidar la transacci�n.
