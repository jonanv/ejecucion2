...
/*------------- Adicionar Memorial -------------------*/
	...
	//NUEVO 5 DE AGOSTO 2021
	
	public function Memoriales_Entidad_Radicados(){
		...
		if($_SESSION['id']!=""){
			...
			$this->view->show("expediente_memoriales_entidad.php", $data);
	...
	public function Busquedad_Memoriales_Externos_Radicados_Entidades(){
		...
		if($_SESSION['id']!=""){
			...
			header("refresh: 0; URL=/publicaciones/");

		}	

	}
	
	public function Descargar_Multiples_Archivos_Entidad(){
	
			require 'models/archivoModel.php';

			$modelo = new archivoModel();
			
			$modelo->descargar_multiples_archivos_entidad();
    }
	
	public function Radicar_Memorial_Entidad(){
		...
		if($_SESSION['id']!=""){
			...
			//if($_POST){
				...
				$modelo->radicar_memorial_entidad();
			//}
	...
	public function Radicar_Devolucion_Memo_Entidad(){
		...
		if($_SESSION['id']!=""){
			...
			//if($_POST){
				...
				$modelo->radicar_devolucion_memo_entidad();
			//}
	...
	//NUEVO 30 DE SEPTIEMBRE 2021
	
	public function Solicitud_Visualizar_Expediente_Entidad(){
			...
			$this->view->show("expediente_solicitud_visualizar_entidad.php", $data);
	...
	public function Solicitud_Visualizar_Expediente_Entidad_Filtro(){
	...
	public function Radicar_Solicitud_Visualizar_Entidad(){
		...
		if($_SESSION['id']!=""){
			...
			//if($_POST){
				...
				$modelo->radicar_solicitud_visualizar_entidad();
			//}
	...
	public function Registrar_Devolucion_Solicitud(){
		...
		if($_SESSION['id']!=""){
			...
			//if($_POST){
				...
				$modelo->registrar_devolucion_solicitud();
			//}
	...
	public function Solicitud_Expediente_Remate(){
		...
		if($_SESSION['id']!=""){
			...
			//if($_POST){
				...
				$modelo->radicar_solicitud_entidadOECM();
			//}
	...
	public function Generar_Excel_Adespacho_Juzgados(){
